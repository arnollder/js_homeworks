...
// alert(this.name);
=======
// Выводит на экран сообщение о глобальном объекте
...
=======
// Дополнительное связывание не переопределит this, так как он уже зафиксирован первым вызовом.
...
// Однако, его вызов приводит к ошибке. Почему?
// function askPassword(ok, fail) {
// let password = prompt("Password?", '');if (password == "rockstar") ok();
// else fail();
// }
// let user = {
// name: 'Вася',
